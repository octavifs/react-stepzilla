...
var StepZilla = function (_Component) {
  ...
  _createClass(StepZilla, [{
    ...
    key: 'onActivate',
    value: function onActivate(isActive) {
      this.setState({ isNextActive: isActive });
    }
    ...
    value: function next() {
      ...
      this.abstractStepMoveAllowedToPromise().then(function () {
        ...
        if (proceed) {
          ...
          _this4.setState({ isNextActive: false });
        }
      }).catch(function (e) {
        if (e) {
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'button',
            {
              ...
              disabled: this.props.disableByDefault && !this.state.isNextActive,
              id: 'next-button'
            },
